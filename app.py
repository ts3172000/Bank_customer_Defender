...
recommendations_list = ["Maintainance Waivers", "Cash Bonus", "Insurance Discount", "Premium Membership", "Discount Coupen", "Sign-up Bonuses", "Interest Hike", "Investment Advices", "Referral Programs",
                         "Mortage offers"]
...
def predict():
    if session.get('logged_in'):
        ...
        Geography = Geography_invers(Geography)

        Gender = custd['Gender']
        Gender = Gender_invers(Gender)
        ...
        project = (c_id, CreditScore, Geography, Gender, 
                ...
                HasCrCard, IsActiveMember, EstimatedSalary, pred,recod_1,recod_2);
